...
public class WebhookFilterRequest
{
    ...
    [Display("Trigger if all language fields are not exists", Description = "If true, the event will trigger only if the specified 'Translation language' does not appear in the content at all.")]
